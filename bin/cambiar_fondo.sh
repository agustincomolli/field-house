...
# cambiar_fondo.sh — motor de la app
# Versión: 1.1.0
#
...
#   cambiar_fondo.sh --dry-run  muestra qué fondo se aplicaría sin tocar
#                                xfconf ni los archivos de estado/red
#   cambiar_fondo.sh --version  muestra la versión
#   cambiar_fondo.sh --help     muestra la ayuda completa
#
