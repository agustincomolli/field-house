...
REM Install.cmd — atajo para instalar sin lidiar con la politica de ejecucion
REM de PowerShell.
REM
REM Windows bloquea por defecto la ejecucion de scripts .ps1 (Restricted).
REM Install.ps1 no cambia esa politica de forma global ni persistente: este
...
REM consola con "Install.cmd" (sin el punto y barra que hace falta con
REM PowerShell).
REM ============================================================================
...
echo.
if %EXIT_CODE% neq 0 (
    echo La instalacion termino con un error ^(codigo %EXIT_CODE%^). Revisa los mensajes de arriba.
) 
